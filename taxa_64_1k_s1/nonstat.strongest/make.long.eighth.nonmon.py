...
t.setModelThing(y, node=26, clade=1)
t.setModelThing(y, node=67, clade=1)
...
t.data.writeNexus(fName="sim.long.eighth.nonmon.10.nex", writeDataBlock=1, interleave=0, flat=1, append=0)
