...
t = var.trees[0]
a = func.newEmptyAlignment(dataType='dna', taxNames=['t1', 't2', 't3', 't4', 't5', 't6', 't7', 't8', 't17', 't18', 't19', 't20', 't21', 't22', 't23', 't24', 't9', 't10', 't11', 't12', 't13', 't14', 't15', 't16', 't25', 't26', 't27', 't28', 't29', 't30', 't31', 't32'], length=10000)
t.data = Data([a])
...
t.setModelThing(y, node=56, clade=1)
...
t.data.writeNexus(fName="trial.nex", writeDataBlock=1, interleave=0, flat=1, append=0)
